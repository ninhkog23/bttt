...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('bs-front-end/css/style.css') }}">
    <script src="{{ URL::asset('bs-front-end/js/jquery.min.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('bs-front-end/js/materialize.min.js') }}"></script>
<link href="{{ URL::asset('bs-back-end/owl-carousel/owl.carousel.min.css' )}}"  rel="stylesheet" />
<link href="{{ URL::asset('bs-back-end/owl-carousel/owl.theme.default.min.css') }}" rel="stylesheet" />
<link href="{{ URL::asset('bs-back-end/css/style.css' )}}" rel="stylesheet") />
<script src="{{ URL::asset('bs-back-end/owl-carousel/owl.carousel.min.js') }}"></script>
...
<body >
    ...
    @section('footer')
    @show
<script src="{{ URL::asset('bs-back-end/js/script-admin.js') }}"></script>
</body>
</html>