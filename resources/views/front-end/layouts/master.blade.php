...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('bs-front-end/css/normalize.css') }}">
     <link rel="stylesheet" href="{{ URL::asset('bs-front-end/css/swiper.min.css') }}">
    ...
    <script src="{{ URL::asset('bs-front-end/js/swiper.jquery.min.js') }}"></script>
    <script src="{{ URL::asset('lib/jquery.number.min.js') }}"></script>
    <script src="{{ URL::asset('bs-front-end/js/myscript.js') }}"></script>
